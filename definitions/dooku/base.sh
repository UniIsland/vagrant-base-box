...
aptitude -q2 -y install bash-completion bzip2 ca-certificates curl git htop less lsof nfs-common rsync ruby unzip vim-nox zsh
...
aptitude -q2 -y install rbenv ruby-build
