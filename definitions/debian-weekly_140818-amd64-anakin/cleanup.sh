...
# Log
#dpkg --get-selections > /var/log/vagrant_box_build/dpkg_selections.1.txt
#apt-mark showmanual | sort > /var/log/vagrant_box_build/apt_mark.1.txt
#df -h > /var/log/vagrant_box_build/disk_free.1.txt
